...
OUT=ROOT/'R21_E001_B02_ORDER_FIXED_GENERATION'
ZIP=ROOT/'R21_E001_B02_ORDER_FIXED_GENERATION.zip'
...
def build_object_chunk(n:int):
    ...
    return HEADER+b''.join(inputs)+b''.join(outputs)+SEP+b''.join(groups),maps
