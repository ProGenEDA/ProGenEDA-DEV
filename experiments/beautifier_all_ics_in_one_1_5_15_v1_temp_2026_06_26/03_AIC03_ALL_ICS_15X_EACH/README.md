# AIC03_ALL_ICS_15X_EACH

## Purpose

All supported IC families in one bare component-placement project, `15` of each.
This stresses mixed IC footprints after the solo family tests.

## What To Check In Proteus

- There should be `15` package groups for every listed IC family.
