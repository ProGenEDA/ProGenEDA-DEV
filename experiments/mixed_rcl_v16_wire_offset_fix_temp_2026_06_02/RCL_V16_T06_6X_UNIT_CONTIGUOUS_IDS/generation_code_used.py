...
OUT_ROOT = REPO_ROOT / "experiments" / "mixed_rcl_v16_wire_offset_fix_temp_2026_06_02"
...
def main() -> int:
    ...
    archive = shutil.make_archive(str(REPO_ROOT / "experiments" / "MIXED_RCL_V16_WIRE_OFFSET_FIX_TEMP_2026_06_02"), "zip", OUT_ROOT)
