...
_SPECS = [
    ...
    _spec("TERMINAL_BLOCK_4", "Terminal Block 4-pin", "J", 14.0, 9.0, "terminal"),
    ...
    _spec("GROUND", "Ground", "#PWR", 5.0, 4.0, "power_symbol"),
    _spec("VDC", "DC Voltage Source", "V", 10.0, 12.0, "source"),
    _spec("VSOURCE", "Voltage Source", "V", 10.0, 12.0, "source"),
    _spec("CSOURCE", "Current Source", "I", 10.0, 12.0, "source"),
    _spec("VSIN", "Sine Voltage Source", "V", 10.0, 12.0, "source"),
    _spec("VPULSE", "Pulse Voltage Source", "V", 10.0, 12.0, "source"),
    _spec("RES", "Resistor", "R", 7.0, 2.5, "resistor"),
    _spec("POT-HG", "Potentiometer", "RV", 9.0, 9.0, "potentiometer"),
    _spec("CAP", "Capacitor", "C", 4.0, 3.0, "capacitor"),
    _spec("CAP-ELEC", "Electrolytic Capacitor", "C", 6.0, 6.0, "capacitor"),
    _spec("REALIND", "Inductor", "L", 9.0, 9.0, "inductor"),
    _spec("1N4007", "1N4007 Diode", "D", 8.0, 3.0, "diode"),
    _spec("1N4148", "1N4148 Diode", "D", 8.0, 3.0, "diode"),
    _spec("1N60", "1N60 Diode", "D", 8.0, 3.0, "diode"),
    _spec("BZX55C5", "BZX55C5 Zener Diode", "D", 8.0, 3.0, "zener_diode"),
    _spec("BZX79C5", "BZX79C5 Zener Diode", "D", 8.0, 3.0, "zener_diode"),
    _spec("LED", "LED", "D", 5.0, 5.0, "indicator"),
    _spec("NPN", "NPN Transistor", "Q", 5.0, 4.0, "bjt"),
    _spec("PNP", "PNP Transistor", "Q", 5.0, 4.0, "bjt"),
    _spec("NMOS", "NMOS Transistor", "Q", 7.0, 6.0, "mosfet"),
    _spec("2N7000", "2N7000 NMOS", "Q", 7.0, 6.0, "mosfet"),
    _spec("BS170", "BS170 NMOS", "Q", 7.0, 6.0, "mosfet"),
    _spec("OPAMP", "Op-Amp", "U", 18.0, 22.0, "opamp"),
    _spec("LM741", "LM741 Op-Amp", "U", 18.0, 22.0, "opamp"),
    _spec("NE555", "NE555 Timer", "U", 18.0, 22.0, "timer_ic"),
    _spec("CD4007", "CD4007 CMOS Array", "U", 18.0, 24.0, "logic_ic"),
    _spec("LM317", "LM317 Adjustable Regulator", "U", 10.0, 8.0, "regulator"),
    _spec("TRANSFORMER", "Transformer", "T", 18.0, 14.0, "transformer"),
    _spec("BRIDGE RECTIFIER", "Bridge Rectifier", "BR", 12.0, 10.0, "diode_bridge"),
    _spec("SWITCH", "Switch", "SW", 6.0, 4.0, "switch"),
    _spec("TERMINAL", "Terminal", "J", 10.0, 8.0, "terminal"),
    _spec("7SEGCOMA", "7-Segment Common Anode", "DS", 18.0, 22.0, "display"),
    _spec("7SEGCOMK", "7-Segment Common Cathode", "DS", 18.0, 22.0, "display"),
    _spec("4027", "4027 Dual JK Flip-Flop", "U", 18.0, 24.0, "logic_ic"),
    _spec("4511", "4511 BCD to 7-Segment Latch/Decoder", "U", 22.0, 28.0, "logic_ic"),
    _spec("7447", "7447 BCD to 7-Segment Decoder", "U", 22.0, 28.0, "logic_ic"),
    _spec("7490", "7490 Decade Counter", "U", 18.0, 24.0, "logic_ic"),
    _spec("74HC00", "74HC00 Quad NAND Gate", "U", 18.0, 24.0, "logic_ic"),
    _spec("74HC02", "74HC02 Quad NOR Gate", "U", 18.0, 24.0, "logic_ic"),
    _spec("74HC04", "74HC04 Hex Inverter", "U", 18.0, 30.0, "logic_ic"),
    _spec("74HC08", "74HC08 Quad AND Gate", "U", 18.0, 24.0, "logic_ic"),
    _spec("74HC32", "74HC32 Quad OR Gate", "U", 18.0, 24.0, "logic_ic"),
    _spec("74HC74", "74HC74 Dual D Flip-Flop", "U", 18.0, 24.0, "logic_ic"),
    _spec("74HC76", "74HC76 Dual JK Flip-Flop", "U", 18.0, 24.0, "logic_ic"),
    _spec("74HC85", "74HC85 4-Bit Comparator", "U", 22.0, 28.0, "logic_ic"),
    _spec("74HC86", "74HC86 Quad XOR Gate", "U", 18.0, 24.0, "logic_ic"),
    _spec("74HC151", "74HC151 8-Input Multiplexer", "U", 22.0, 28.0, "logic_ic"),
    _spec("74HC157", "74HC157 Quad 2-Input Multiplexer", "U", 22.0, 28.0, "logic_ic"),
    _spec("74HC160", "74HC160 Counter", "U", 22.0, 28.0, "logic_ic"),
    _spec("74HC174", "74HC174 Hex D Flip-Flop", "U", 22.0, 28.0, "logic_ic"),
    _spec("74HC192", "74HC192 Up/Down Counter", "U", 22.0, 28.0, "logic_ic"),
    _spec("74HC266", "74HC266 Quad XNOR Gate", "U", 18.0, 24.0, "logic_ic"),
    _spec("74HC283", "74HC283 4-Bit Adder", "U", 22.0, 28.0, "logic_ic"),
]
...
PLACER_KIND_LIB_IDS: dict[str, str] = {
    ...
    "TERMINAL_BLOCK_4": "Connector:Screw_Terminal_01x04",
    ...
    "LED_ARRAY": "Connector_Generic:Conn_02x08_Odd_Even",
    "RESISTOR_NETWORK": "Connector_Generic:Conn_02x08_Odd_Even",
    ...
    "CSOURCE": "Simulation_SPICE:IDC",
    "VSIN": "Simulation_SPICE:VSIN",
    "VPULSE": "Simulation_SPICE:VPULSE",
    "RES": "Device:R",
    "POT_HG": "Device:R_Potentiometer",
    "CAP": "Device:C",
    "CAP_ELEC": "Device:C_Polarized",
    "REALIND": "Device:L",
    "1N4007": "Diode:1N4007",
    "1N4148": "Diode:1N4148",
    "1N60": "Device:D",
    "BZX55C5": "Device:D_Zener",
    "BZX79C5": "Device:D_Zener",
    "LED": "Device:LED",
    "NPN": "Transistor_BJT:Q_NPN_BCE",
    "PNP": "Transistor_BJT:Q_PNP_BCE",
    "NMOS": "Transistor_FET:Q_NMOS_DGS",
    "2N7000": "Transistor_FET:2N7000",
    "BS170": "Transistor_FET:BS170",
    "OPAMP": "Amplifier_Operational:LM741",
    "LM741": "Amplifier_Operational:LM741",
    "NE555": "Timer:NE555P",
    "CD4007": "Transistor_FET:Q_Dual_NMOS_PMOS_G1S2G2D2S1D1",
    "LM317": "Regulator_Linear:LM317_TO-220",
    "TRANSFORMER": "Device:Transformer_1P_1S",
    "BRIDGE_RECTIFIER": "Device:D_Bridge_+-AA",
    "SWITCH": "Switch:SW_SPST",
    "TERMINAL": "Connector_Generic:Conn_01x02",
    "7SEGCOMA": "Display_Character:KCSA02-107",
    "7SEGCOMK": "Display_Character:KCSC02-107",
    "4027": "4xxx:4027",
    "4511": "4xxx_IEEE:4511",
    "7447": "74xx_IEEE:7447",
    "7490": "74xx_IEEE:7490",
    ...
    "74HC85": "74xx:74HC85",
    "74HC86": "74xx:74HC86",
    "74HC151": "74xx:74LS151",
    "74HC157": "74xx:74LS157",
    "74HC160": "74xx:74LS160",
    "74HC174": "74xx:74LS174",
    "74HC192": "74xx:74HC192",
    "74HC266": "4xxx:4077",
    "74HC283": "74xx:74LS283",
}
