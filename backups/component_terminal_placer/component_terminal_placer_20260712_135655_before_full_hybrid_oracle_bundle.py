    ...
    for family in requested_native:
        ...
        pairs, family_terminals, family_wires, family_patches = (
            _mixed_overlay_family_parts(
                ...
                active_links=True,
                # P002's hybrid Ctrl+S oracle establishes 0200 for the native
                # RESISTOR/CAP forms.  Generic diode-family records retain
                # their accepted 0100 donor trailer while their own combined
                # BJT oracle is being resolved.
                active_link_trailer=(
                    b"\x02\x00"
