"""Generate V9 mixed-control selector matrix for SWITCH/POT-HG.

V8 user result:
- B01/B02: SWITCH correct, POT-HG incorrect;
- B07: SWITCH incorrect, POT-HG correct.

Rules under test:
- keep the V6 accepted 00 08 chunk header;
- keep accepted FUSE/PNP/VPULSE selectors and full donor ROOT.CDB;
- vary only the failing control family while holding the known-good side fixed.
"""
...
OUT_DIR = ROOT / "experiments/new_component_mega_probe_v9_control_matrix_temp_2026_06_19"
ZIP_OUT = ROOT / "experiments/NEW_COMPONENT_MEGA_PROBE_V9_CONTROL_MATRIX_TEMP_2026_06_19.zip"
...
def build_cases() -> dict[str, object]:
    ...
    profile_specs = [
        (
            "P01_ONE_POT_BLOCK1_SWITCH_BLOCK2",
            "M01_CONTROL_ONE_EACH",
            {"SWITCH": 21, "POT-HG": 0},
            {},
            "M01: keep known-good small SWITCH block2, test POT-HG from block1.",
        ),
        (
            "P02_ONE_POT_BLOCK3_SWITCH_BLOCK2",
            "M01_CONTROL_ONE_EACH",
            {"SWITCH": 21, "POT-HG": 40},
            {},
            "M01: keep known-good small SWITCH block2, test POT-HG from block3.",
        ),
        (
            "P03_ONE_POT_SKIP_EACH_SWITCH_BLOCK2",
            "M01_CONTROL_ONE_EACH",
            {"SWITCH": 21},
            {"POT-HG": 20},
            "M01: keep known-good small SWITCH block2, skip first POT-HG inside each block.",
        ),
        (
            "P04_FIVE_POT_BLOCK3_SWITCH_BLOCK2",
            "M02_CONTROL_FIVE_EACH",
            {"SWITCH": 21, "POT-HG": 40},
            {},
            "M02: keep known-good small SWITCH block2, test five POT-HG from block3.",
        ),
        (
            "P05_FIVE_POT_SKIP_EACH_SWITCH_BLOCK2",
            "M02_CONTROL_FIVE_EACH",
            {"SWITCH": 21},
            {"POT-HG": 20},
            "M02: keep known-good small SWITCH block2, skip first POT-HG inside each block.",
        ),
        (
            "S01_LARGE_SWITCH_BLOCK3_POT_BLOCK2",
            "M07_CONTROL_LARGE_STRESS",
            {"SWITCH": 42, "POT-HG": 20},
            {},
            "M07: keep known-good large POT-HG block2, test SWITCH from block3.",
        ),
        (
            "S02_LARGE_SWITCH_BLOCK4_POT_BLOCK2",
            "M07_CONTROL_LARGE_STRESS",
            {"SWITCH": 63, "POT-HG": 20},
            {},
            "M07: keep known-good large POT-HG block2, test SWITCH from block4.",
        ),
        (
            "S03_LARGE_SWITCH_SKIP_EACH_POT_BLOCK2",
            "M07_CONTROL_LARGE_STRESS",
            {"POT-HG": 20},
            {"SWITCH": 21},
            "M07: keep known-good large POT-HG block2, skip first SWITCH inside each block.",
        ),
        (
            ...
            {"SWITCH": 22, "POT-HG": 20},
            {},
            "M07: keep known-good large POT-HG block2, test SWITCH block2 shifted by one.",
        ),
    ]
    for case_id, base_case, offsets, skip_each, description in profile_specs:
        ...
        focused_specs.append(
            (
                ...
                description,
                {
                    ...
                    "selector": "v9_family_split_control_profile",
    ...
    return {
        "experiment": "new_component_mega_probe_v9_control_matrix_temp_2026_06_19",
        "purpose": "Mixed-case correction for V8: independently vary SWITCH and POT-HG control windows based on user results.",
        "separated_families": separated_families,
        "skipped_requests": skipped,
        "rule_under_test": "For mixed outputs, use full donor ROOT.CDB, accepted trim rules, a 00 08 object chunk header, and family-split control packet windows.",
        "donor_counts": {
