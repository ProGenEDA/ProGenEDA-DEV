...
OUT=ROOT/'R21_E001_B02_SUFFIX_LINKED_V8'
ZIP=ROOT/'R21_E001_B02_SUFFIX_LINKED_V8.zip'
...
def patch_res(t:bytearray,idx:int,ref:str,val:str,x:int,y:int,in_suf:int,out_suf:int):
    ...
    # r[345] remains record/group terminator byte
    return bytes(r)
