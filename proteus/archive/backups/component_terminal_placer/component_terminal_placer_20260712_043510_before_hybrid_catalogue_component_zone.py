...
def attach_mixed_component_and_catalogue_bidir_terminals_to_project(
    ...
    *,
    ...
    for family in requested_native:
        ...
        pairs, family_terminals, family_wires, family_patches = (
            _mixed_overlay_family_parts(
                ...
                active_links=True,
                # P002's Proteus Ctrl+S oracle proves a hybrid-specific 0200
                # link trailer for RESISTOR/CAP.  Every other native family
                # retains its accepted donor-native 0100 trailer until its
                # own hybrid save oracle proves a different form.
                active_link_trailer=(
                    b"\x02\x00"
                    if family in {"RESISTOR", "CAP"}
                    else b"\x01\x00"
                ),
    ...
    report = {
        ...
        "component_record_order_mutation": bool(catalogue_leading_by_group_id),
