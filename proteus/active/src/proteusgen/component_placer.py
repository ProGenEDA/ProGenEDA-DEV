...
TRUSTED_DONOR_MANIFEST_PATH = Path("evidence/registry/trusted_donor_manifest.json")
...
NEW_COMPONENT_MEGA_DONOR = Path("evidence/donors/manual_downloads_20260618/new_component_mega/new_components_5x_mega.pdsprj")
...
MAIN_MEGA_NO_SOURCE_DONOR = Path(
    "evidence/donors/main_mega_20260618/"
