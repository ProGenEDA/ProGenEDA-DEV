...
def build_arguments() -> list[str]:
    ...
    add_data = (
        ...
        (
            ROOT / "evidence" / "registry" / "trusted_donor_manifest.json",
            "evidence/registry",
        ),
        (
            ROOT / "evidence" / "registry" / "native_components.json",
            "evidence/registry",
        ),
        (
            ROOT
            ...
            "evidence/donors/manual_downloads_20260618/new_component_mega",
        ),
    )
    args = [
        "--noconfirm",
        ...
        f"--workpath={WORKSPACE_ROOT / 'build' / 'progen_proteus_exe'}",
        f"--specpath={WORKSPACE_ROOT / 'build' / 'progen_proteus_exe'}",
