"""Display and 4027 component-specific diagnostics after V4/V5 rejection.
...
OUT_DIR = ROOT / "experiments/bare_display_4027_focus_v6_temp_2026_06_16"
ZIP_OUT = ROOT / "experiments/BARE_DISPLAY_4027_FOCUS_V6_TEMP_2026_06_16.zip"
...
def build_cases() -> dict[str, object]:
    ...
    return {
        "experiment": "bare_display_4027_focus_v6_temp_2026_06_16",
        "purpose": "Component-specific diagnostics/fixes for display and 4027 after V4 user rejection, with V6 display object-boundary splitting.",
