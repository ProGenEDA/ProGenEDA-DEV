"""Generate the 30-circuit final combinational IC acceptance pack.
...
OUT_ROOT = REPO / "proteus" / "experiments" / "runs" / "ic_final_30_combinational_v1_temp_2026_06_08"
ARCHIVE_PATH = REPO / "proteus" / "experiments" / "runs" / "IC_FINAL_30_COMBINATIONAL_V1_TEMP_2026_06_08.zip"
...
def main() -> None:
    ...
    summary = {
        "batch": "IC_FINAL_30_COMBINATIONAL_V1_TEMP_2026_06_08",
        "purpose": "Thirty final combinational IC circuits from user blueprint, generated from accepted donor-derived gate/passive records.",
        ...
        "shared_rules": [
            ...
            "R/C/L endpoints use $TERBIDIR; V0/G0 special terminals appear only in passive mixed cases.",
