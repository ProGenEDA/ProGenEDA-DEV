...
V3_PATH = REPO_ROOT / "proteus" / "experiments" / "runners" / "2026-05-31" / "generate_inductor_v3_multi_temp.py"
...
OUT_ROOT = REPO_ROOT / "proteus" / "experiments" / "runs" / "inductor_v4_power_ground_temp_2026_05_31"
...
def main() -> int:
    ...
    shutil.make_archive(str(REPO_ROOT / "proteus" / "experiments" / "runs" / "INDUCTOR_V4_POWER_GROUND_TEMP_2026_05_31"), "zip", OUT_ROOT)
