...
OUT_ROOT = REPO_ROOT / "experiments" / "inductor_v8_six_donor_temp_2026_06_01"
...
def main() -> int:
    ...
    shutil.make_archive(str(REPO_ROOT / "experiments" / "INDUCTOR_V8_SIX_DONOR_TEMP_2026_06_01"), "zip", OUT_ROOT)
