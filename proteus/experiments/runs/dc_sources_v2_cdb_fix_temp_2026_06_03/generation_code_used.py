...
OUT_ROOT = EXPERIMENT_ROOT / "DC_SOURCES_V2_CDB_FIX_TEST_BATCH"
...
def build_cases() -> list[dict[str, Any]]:
    ...
    cases.append(
        _generate_case(
            case_id="DCS_V2_T01_DCV_6_COMPONENTS",
    ...
    cases.append(
        _generate_case(
            case_id="DCS_V2_T02_DCV_21_COMPONENTS",
    ...
    cases.append(
        _generate_case(
            case_id="DCS_V2_T03_DCI_6_COMPONENTS",
    ...
    cases.append(
        _generate_case(
            case_id="DCS_V2_T04_DCI_21_COMPONENTS",
    ...
    cases.append(
        _generate_case(
            case_id="DCS_V2_T05_COMPLEX_RLC_01",
    ...
    cases.append(
        _generate_case(
            case_id="DCS_V2_T06_COMPLEX_RLC_02",
    ...
    cases.append(
        _generate_case(
            case_id="DCS_V2_T07_COMPLEX_RLC_03",
    ...
    cases.append(
        _generate_case(
            case_id="DCS_V2_T08_COMPLEX_RLC_04",
    ...
    cases.append(
        _generate_case(
            case_id="DCS_V2_T09_COMPLEX_RLC_05",
...
def main() -> None:
    ...
    cases = build_cases()
    batch = {
        "batch_id": "DC_SOURCES_V2_CDB_FIX_TEMP_20260603",
    ...
    archive = shutil.make_archive(str(EXPERIMENT_ROOT / "DC_SOURCES_V2_CDB_FIX_TEMP_2026_06_03"), "zip", OUT_ROOT)
